...
/*preloader bilder*/
(function () {
    var moves = [ "../img/brikkene/kingmoves.png", "../img/brikkene/queenmoves.png", "../img/brikkene/rookmoves.png", "../img/brikkene/bishopmoves.png", "../img/brikkene/knightmoves.png", "../img/brikkene/pawnmoves.png", '../img/brikkene/king2.png', '../img/brikkene/queen2.png', '../img/brikkene/rook2.png', '../img/brikkene/bishop2.png', '../img/brikkene/knight2.png', '../img/brikkene/pawn2.png'];
...
function show (brikke) {
  ...
  if (brikke === "0") {
    ...
    document.getElementById('konge').src = '../img/brikkene/king2.png';
    document.getElementById('dronning').src = '../img/brikkene/queen.png';
    document.getElementById('tarn').src = '../img/brikkene/rook.png';
    document.getElementById('loper').src = '../img/brikkene/bishop.png';
    document.getElementById('springer').src = '../img/brikkene/knight.png';
    document.getElementById('bonde').src = '../img/brikkene/pawn.png';
		...
		document.getElementById('brikkerimg').innerHTML = '<img src="../img/brikkene/kingmoves.png" alt="" title="original image by Wikipedia user Cburnett"/><p class="text-muted">Kongens mulige trekk.</p>';
    ...
    document.getElementById('konge').src = '../img/brikkene/king.png';
    document.getElementById('dronning').src = '../img/brikkene/queen2.png';
    document.getElementById('tarn').src = '../img/brikkene/rook.png';
    document.getElementById('loper').src = '../img/brikkene/bishop.png';
    document.getElementById('springer').src = '../img/brikkene/knight.png';
    document.getElementById('bonde').src = '../img/brikkene/pawn.png';
		...
		document.getElementById('brikkerimg').innerHTML = '<img src="../img/brikkene/queenmoves.png" alt="" title="original image by Wikipedia user Cburnett"/><p class="text-muted">Dronningens mulige trekk.</p>';
    ...
    document.getElementById('konge').src = '../img/brikkene/king.png';
    document.getElementById('dronning').src = '../img/brikkene/queen.png';
    document.getElementById('tarn').src = '../img/brikkene/rook2.png';
    document.getElementById('loper').src = '../img/brikkene/bishop.png';
    document.getElementById('springer').src = '../img/brikkene/knight.png';
    document.getElementById('bonde').src = '../img/brikkene/pawn.png';
		...
		document.getElementById('brikkerimg').innerHTML = '<img src="../img/brikkene/rookmoves.png" alt="" title="original image by Wikipedia user Cburnett"/><p class="text-muted">Tårnets mulige trekk.</p>';
    ...
    document.getElementById('dronning').src = '../img/brikkene/queen.png';
    document.getElementById('tarn').src = '../img/brikkene/rook.png';
    document.getElementById('loper').src = '../img/brikkene/bishop2.png';
    document.getElementById('springer').src = '../img/brikkene/knight.png';
    document.getElementById('bonde').src = '../img/brikkene/pawn.png';
		...
		document.getElementById('brikkerimg').innerHTML = '<img src="../img/brikkene/bishopmoves.png" alt="" title="original image by Wikipedia user Cburnett"/><p class="text-muted">Løperens mulige trekk.</p>';
    ...
    document.getElementById('tarn').src = '../img/brikkene/rook.png';
    document.getElementById('loper').src = '../img/brikkene/bishop.png';
    document.getElementById('springer').src = '../img/brikkene/knight2.png';
    document.getElementById('bonde').src = '../img/brikkene/pawn.png';
		...
		document.getElementById('brikkerimg').innerHTML = '<img src="../img/brikkene/knightmoves.png" alt="" title="original image by Wikipedia user Cburnett"/><p class="text-muted">Springerens mulige trekk.</p>';
    ...
    document.getElementById('loper').src = '../img/brikkene/bishop.png';
    document.getElementById('springer').src = '../img/brikkene/knight.png';
    document.getElementById('bonde').src = '../img/brikkene/pawn2.png';
		...
		document.getElementById('brikkerimg').innerHTML = '<img src="../img/brikkene/pawnmoves.png" alt="" title="original image by Wikipedia user Cburnett"/><p class="text-muted">Bondens mulige trekk.</p>';
